...
- **codegen: 82 match, 0 differ, 28 unported, 11 rejected by both** —
  340,577 of 354,765 file-specific IR lines.
- **canaries: 129 registered, 0 missed.**
...
could not. `bootstrap/canary.py` holds a hundred and twenty-nine
