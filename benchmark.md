...
|---|---|---|---|
| Festina (`img?`) | 8 ms (median 9 ms) | 7 ms (median 8 ms) | 1.14x |
| Browser (Skia, OffscreenCanvas) | 115 ms (median 121 ms) | 45 ms (median 49 ms) | 2.57x |

On this workload, both multi-threaded, **Festina's threads draw it 6.4x faster**.
