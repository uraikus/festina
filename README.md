...
Version 0.43 — see [CHANGELOG.md](CHANGELOG.md).

[![Tests](https://img.shields.io/badge/tests-2283%20passing-brightgreen)](tests/CONTRACT.md)
...
real and tested: **2283 tests, 0 failures** (11 more skip cleanly when
