...
[![Tests](https://img.shields.io/badge/tests-3338-brightgreen)](tests/CONTRACT.md)
...
real and tested: **3,338 tests**, of which the ones whose platform
...
`.f` file in the repository on each run, and a hundred and forty-five
