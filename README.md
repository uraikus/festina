...
Version 0.42 — see [CHANGELOG.md](CHANGELOG.md).

[![Tests](https://img.shields.io/badge/tests-2264%20passing-brightgreen)](tests/CONTRACT.md)
...
real and tested: **2264 tests, 0 failures** (10 more skip cleanly when
