...
Version 0.37 — see [CHANGELOG.md](CHANGELOG.md).

[![Tests](https://img.shields.io/badge/tests-2207%20passing-brightgreen)](tests/CONTRACT.md)
...
real and tested: **2207 tests, 0 failures** (9 more skip cleanly when
