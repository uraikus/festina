...
A struct-typed field of an arr[T]/map[T] element, and an arr[T]/map[T]-typed field of a struct, are not covered by this section -- see section 76's own boundary on arr[T]/map[T] values generally, and todo.md for what extending reference counting to arr[T]/map[T] values themselves would still require before either could be addressed.
